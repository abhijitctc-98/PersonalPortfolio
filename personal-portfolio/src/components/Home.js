...
import DevIconsBackground from './ui/DevIconsBackground';
...
export const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      {/* This ensures the DevIconsBackground is behind all the content */}
      <DevIconsBackground />
        ...
        <div className="w-full max-w-md space-y-6 bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          >
            ...
            <Slider
              ...
              step={1}
            />
            <div className="mt-2 text-right text-primary font-bold">
              {energy}%
            </div>
          </motion.div>
